...
The stratum corneum has high electrical impedance because of its low moisture content and dense structure~\cite{tronstad_current_2022}. Two distinct pathways alter this impedance during sweating. When eccrine sweat ducts fill, the ionic content of the sweat forms a low-resistance pathway through the stratum corneum and contributes to the phasic \glsreset{scr}~\cite{tronstad_current_2022}. Continued sweating also hydrates the stratum corneum itself and raises its bulk conductivity, which underlies the tonic \glsreset{scl}~\cite{boucsein_electrodermal_2012}. The two pathways act together to shape the recorded skin conductance signal.
